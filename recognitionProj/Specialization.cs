namespace recognitionProj
{
    public class Specialization
    {
        ...
        private int _numFreeProf; // عدد المدرسين المتفرغين (Full-Time Teachers) TODO RENAME WITH PROF
        private int _numPartTimeProf; // عدد المدرسين غير المتفرغين (Part-Time Teachers) TODO RENAME WITH PROF
                              ...
                              string specAttachName, string specAttachDesc, int color, int numPhdHolders, int? practicalHours, int? theoreticalHours)
        {
            ...
            _type = type;
            _numStu = numStu;
            _numFreeProf = numFreeProf;
            _numPartTimeProf = numPartTimeProf;
            _numProf = numProf;
